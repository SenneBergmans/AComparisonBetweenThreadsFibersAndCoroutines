...
public:
	...
	CoroutineHandler(CoroutineHandler&& original) noexcept :
		coroutine_(original.coroutine_), full_(original.full_) {
		//Remove the coroutine_ pointer of the original CoroutineHandler instance
