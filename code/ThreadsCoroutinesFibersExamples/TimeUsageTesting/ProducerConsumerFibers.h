...
class ProducerConsumerFibers
{
public:
	/// <summary>
	/// Run all producer consumer tests using fibers.
	/// 
...
private:
	...
	/// <param name="producerNumber">The identification number of the fiber to help visualisation in debugPrint.</param>
	static void singleProducerFunction(int input, std::vector<int>* numberVector, int vectorSize, int producerNumber);
	...
	/// <param name="numberVector">The vector where the numbers will be stored.</param>
	/// <param name="consumerNumber">The identification number of the fiber to help visualisation in debugPrint.</param>
	static void singleConsumerFunction(int input, std::vector<int>* numberVector, int consumerNumber);
	...
	/// <param name="vectorSize">The max size of 'numberVector'.</param>
	/// <param name="producerNumber">The identification number of the fiber to help visualisation in debugPrint.</param>
	static void fullProducerFunction(int input, std::vector<int>* numberVector, int vectorSize, int producerNumber);
	...
	/// <param name="numberVector">The vector where the numbers will be stored.</param>
	/// <param name="consumerNumber">The identification number of the fiber to help visualisation in debugPrint.</param>
	static void fullConsumerFunction(int input, std::vector<int>* numberVector, int consumerNumber);
};
